...
export default function MasterClass() {
  ...
  const filteredMasterclass = useMemo(() => {
    ...
    return matchedMasterclass || null; // Return null if no match is found
  ...
  const CustomCalendar = () => {
    ...
    return (
      <div className="bg-white/95 min-h-[355px] backdrop-blur-sm rounded-3xl p-6 shadow-lg border border-[var(--brown-color)]/10">
    ...
    <div className="md:pt-0 pt-14 min-h-screen bg-[var(--main-color)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {loading ? (
            ...
            <div className="lg:col-span-2 space-y-6">
              {filteredMasterclass && (
                <div className="bg-white/95 min-h-[355px] backdrop-blur-sm rounded-3xl p-6 shadow-lg border border-[var(--brown-color)]/10 flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <Link
                      ...
                      className={`inline-block px-6 py-3 rounded-full self-end font-bold text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl ${
                        filteredMasterclass.availableSlots -
                          filteredMasterclass.pickedSlots >
                        0
        ...
        <div className="mt-12">
          ...
          {masterclasses.length === 0 && (
            <p className="text-center text-[var(--accent-color)] mt-16">
              {currentLocale === "pl"
